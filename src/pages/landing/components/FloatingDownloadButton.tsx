...
export default function FloatingDownloadButton() {
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-5 right-5 sm:bottom-8 sm:right-8 z-50 flex items-center gap-2 sm:gap-3 pl-4 pr-5 py-3.5 sm:pl-5 sm:pr-6 sm:py-4 rounded-full bg-linear-to-r from-blue-600 to-blue-500 text-white font-bold shadow-2xl shadow-blue-600/40 "
      onClick={() => alert('application en maintenace revenez plus tard')}
    >
