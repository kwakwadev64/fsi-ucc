...
import type { HomeData } from '@/entities/actualite/model'
import { storageUrl } from '@/shared/lib/media'
...
export default function ActualitesSection({
  ...
  return (
    <section
      id="actualite"
      className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 mb-8"
    >
      <SectionTitle
