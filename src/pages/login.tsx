...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F1F5F9] flex items-center justify-center p-4 md:p-10 font-['Poppins']">
      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-6xl overflow-hidden grid grid-cols-1 lg:grid-cols-12 min-h-[750px]">
        ...
        <div className="lg:col-span-6 p-8 md:p-16 flex flex-col justify-between">
          ...
          <div className="max-w-md w-full mx-auto my-auto py-8">
            ...
            <p className="text-gray-500 text-sm mb-8">
              Saisissez votre adresse e-mail et votre mot de passe pour vous authentifier.
            </p>
            ...
            <form onSubmit={handleLoginSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  type="email"
                  required
                  placeholder="votre.adresse@ucc.cd"
            ...
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-2 px-4 py-3 border border-gray-150 rounded-xl hover:bg-gray-50 transition text-sm font-semibold text-gray-700">
                ...
                <svg className="w-5 h-5" viewBox="0 0 24 24">
                  <path fill="#EA4335" d="M12 5.04c1.62 0 3.08.56 4.22 1.65l3.15-3.15C17.45 1.77 14.93 1 12 1 7.35 1 3.39 3.66 1.41 7.54l3.85 2.99C6.18 7.02 8.84 5.04 12 5.04z"/>
                  ...
                  <path fill="#FBBC05" d="M5.26 14.54c-.24-.72-.38-1.49-.38-2.29s.14-1.57.38-2.29L1.41 7.54C.51 9.33 0 11.31 0 13.4s.51 4.07 1.41 5.86l3.85-2.99z"/>
                  <path fill="#34A853" d="M12 23c3.24 0 5.97-1.07 7.96-2.92l-3.9-2.96c-1.08.72-2.48 1.15-4.06 1.15-3.16 0-5.82-1.98-6.78-4.96l-3.85 2.99C3.39 20.34 7.35 23 12 23z"/>
                </svg>
                <span>Google</span>
              </button>
              <button className="flex items-center justify-center gap-2 px-4 py-3 border border-gray-150 rounded-xl hover:bg-gray-50 transition text-sm font-semibold text-gray-700">
            ...
            <div className="text-center mt-8 text-xs font-medium text-gray-500">
              Don't Have An Account? <a href="#" className="text-[#0D3B66] hover:underline font-bold">Register Now</a>
            </div>
          </div>
        ...
        <div className="lg:col-span-6 bg-[#0D3B66] p-8 md:p-16 flex flex-col justify-between text-white relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-blue-700/20 via-transparent to-transparent pointer-events-none"></div>
          <div className="absolute -top-24 -right-24 w-72 h-72 rounded-full border border-white/[0.04] pointer-events-none"></div>
          ...
          <div className="my-auto text-center lg:text-left flex flex-col items-center lg:items-start max-w-lg mx-auto">
            ...
            <p className="text-blue-100/80 text-sm md:text-base leading-relaxed mb-10 max-w-md">
              Restez connecté à votre faculté. Suivez votre progression, accédez aux supports de cours et gardez l'ensemble de votre vie universitaire dans votre poche.
            </p>

            {/* Téléphone en 3D/Flat */}
            <div className="relative w-full max-w-[280px] h-[450px] bg-slate-900 rounded-[3rem] border-4 border-slate-700/80 shadow-2xl p-3 flex flex-col overflow-hidden mb-10 group transform hover:scale-102 transition duration-500">
              {/* Notch */}
              ...
              <div className="flex-1 bg-gradient-to-br from-blue-950 via-slate-900 to-[#0D3B66] rounded-[2.3rem] p-4 pt-8 flex flex-col justify-between text-left relative overflow-hidden select-none">
                ...
                <div className="flex justify-between items-center z-10">
                  <div className="flex items-center gap-1.5">
                    <div className="w-5 h-5 bg-white rounded-md flex items-center justify-center text-[10px] font-bold text-[#0D3B66]">U</div>
                    <span className="text-[10px] font-bold text-white tracking-wide">UCC Hub</span>
                  </div>
                ...
                <div className="my-auto space-y-3 z-10">
                  <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-3.5 shadow-xl">
                    <span className="text-[9px] font-medium text-blue-200">Emploi du temps</span>
                    <h4 className="text-xs font-bold text-white mt-1">Conception de Logiciel (L3)</h4>
                    <p className="text-[9px] text-blue-100/60 mt-0.5">14h30 - Auditoire FSI</p>
                  </div>
                  ...
                  <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-3.5 shadow-xl flex items-center justify-between">
                    <div>
                      <span className="text-[9px] font-medium text-blue-200">Statut Financier</span>
                      <h4 className="text-xs font-bold text-white mt-0.5">Frais validés</h4>
                    </div>
                ...
                <div className="flex justify-around items-center bg-white/5 backdrop-blur-md rounded-xl p-1.5 z-10 border border-white/[0.05]">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-4 w-full">
              ...
              <a 
                href="#" 
                className="flex items-center gap-3 bg-white/10 hover:bg-white/15 border border-white/10 rounded-xl px-4 py-2.5 transition active:scale-95 duration-200 text-left w-full sm:w-auto min-w-[145px]"
              >
                <img src={GooglePlayIcon} alt="Google Play" className="w-6 h-6 text-white fill-current" viewBox="0 0 24 24"/>
                <div>
                  <p className="text-[8px] uppercase tracking-wider text-blue-200 font-semibold leading-none">Get it on</p>
                  <p className="text-xs font-bold mt-0.5 leading-none">Google Play</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  <p className="text-[8px] uppercase tracking-wider text-blue-200 font-semibold leading-none">Download on the</p>
                  <p className="text-xs font-bold mt-0.5 leading-none">App Store</p>
                </div>
              </a>
            </div>
