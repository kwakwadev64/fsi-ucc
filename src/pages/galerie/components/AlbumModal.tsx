  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Sur mobile : occupe tout le modal. Sur desktop : 7/12 colonnes */}
        <div className="md:col-span-7 relative bg-black flex items-center justify-center h-[80vh] md:h-auto md:min-h-75">
          <img
        ...
        {/* Description : masquée sur mobile, visible à partir de md */}
        <div className="hidden md:flex md:col-span-5 p-8 flex-col justify-between bg-white">
          <div>
